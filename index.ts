...
async function display_fetched_activity(username: string) {
    ...
    fs.writeFileSync("results.json", JSON.stringify(json)); // ALWAYS STRINGIFY OBJECT BEFORE WRITING IT TO JSON FILE
